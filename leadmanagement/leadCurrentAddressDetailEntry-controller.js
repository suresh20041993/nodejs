...
exports.leadCurrentAddressDetailEntry = function(req,res){
    ...
    var sql = "SELECT count(leadId) as count FROM ab_constituent_address where leadId = '"+leadId+"' and addressType = '1'";
    console.log(sql);
      connection.query(sql, function (err, result) {
        if (err) {
          ...
          if(result[0].count == '0'){
            ...
            "noOfYears  = '"+leadYearofAddress+"',areaType = '"+areaType+"', userId = '"+userId+"', entryDate = '"+today+"' where leadId = '"+leadId+"' AND addressType = '1'";
